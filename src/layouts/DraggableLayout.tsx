    ...
    const drag = () => {
        ...
        draggableDom.onmousedown =
            (e: any) => {
                ...
                const secondDomStartSize: number = dir === "horizontal" ? secondDom.offsetWidth : secondDom.offsetHeight; // 获取到元素的宽度
                    ...
                    (_event: any) => {
                        ...
                        switch (dir) {
                            case "horizontal":
                                ...
                                // @ts-ignore
                                const baifenbi2 = (
                                    (secondDomStartSize - moveOffset + 5) / (contentDom.offsetWidth - 10)
                                ) * 100;
                            ...
                            case "vertical":
                                ...
                                // @ts-ignore
                                const baifenbi3 = (
                                    (secondDomStartSize - moveOffset1 + 5) / (contentDom.offsetHeight - 10)
                                ) * 100;
